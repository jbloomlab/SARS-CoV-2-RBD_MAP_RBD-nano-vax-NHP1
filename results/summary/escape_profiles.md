...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/NHP_serum_stackedlogo.pdf
     results/escape_profiles/NHP_serum_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/NHP_serum_color_by_bind_stackedlogo.pdf
     results/escape_profiles/NHP_serum_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/NHP_serum_color_by_expr_stackedlogo.pdf
     results/escape_profiles/NHP_serum_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_5.png)
    ...
    Plotted profile 4 to:
     results/escape_profiles/NHP_HCS_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_7.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/NHP_HCS_color_by_bind_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_9.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/NHP_HCS_color_by_expr_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_11.png)
    ...
    Plotted profile 7 to:
     results/escape_profiles/NHP_HCS_altylims_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_altylims_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_13.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/NHP_HCS_altylims_color_by_bind_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_altylims_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_15.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/NHP_HCS_altylims_color_by_expr_stackedlogo.pdf
     results/escape_profiles/NHP_HCS_altylims_color_by_expr_stackedlogo.png.
